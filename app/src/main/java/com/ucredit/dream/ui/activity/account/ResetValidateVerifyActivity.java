...
public class ResetValidateVerifyActivity extends BaseActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent intent) {
        ...
        if(resultCode == ResetPasswordActivity.RESULT_CODE_FINISH){
        	setResult(ResetPasswordActivity.RESULT_CODE_FINISH);
            finish();
        }
    }
    ...
    private void initClickText() {		
        ...
        ssb.setSpan(new ClickableSpan() {
        	...
        	@Override
        	public void onClick(View view) {
        		Utils.customDialog(ResetValidateVerifyActivity.this, "" + Constants.CUSTOMER_SERVICE,
						new DialogListenner() {

							@Override
							public void confirm() {
								Utils.dial(Constants.CUSTOMER_SERVICE, ResetValidateVerifyActivity.this);
							}
						}, "拨打客服热线");
        	}
            ...
            public void onSuccess(String responseString) {
                ...
                try {
                    ...
                    if (object.getBoolean("success")) {//没有注册过
                    	...
                    	Utils.MakeToast(ResetValidateVerifyActivity.this, object
