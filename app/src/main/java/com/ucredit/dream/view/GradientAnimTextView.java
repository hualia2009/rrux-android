...
public class GradientAnimTextView extends TextView {
	private LinearGradient mLinearGradient;
	  ...
	  public GradientAnimTextView(Context ctx)
	  {
	    this(ctx,null);
	  }
	 
	  public GradientAnimTextView(Context context, AttributeSet attrs) {
	    super(context, attrs);
	  }
...
//	      float mTextWidth = getPaint().measureText(getText().toString());
	      float mTextWidth = getWidth();
	      mTranslate += delta;
	      if (mTranslate > mTextWidth+1 || mTranslate<1) {
//	        delta  = -delta;
	    	  mTranslate=0;
	      }
//	      Log.e(""+mTextWidth+"   "+getWidth(), ""+mTranslate);
