...
public class RequestParams implements Serializable {
    ...
    protected String filesKey = "";
    
    public static String clientId = "";//ucredit encrypt key
    public static String key = "";//device id
    ...
    private HttpEntity createJsonStreamerEntity(ResponseHandlerInterface progressHandler) throws IOException {
        JsonStreamerEntity entity = new JsonStreamerEntity(
            ...
            elapsedFieldInJsonStreamer,key,clientId);
    ...
    public void setFilesKey(String key){
        filesKey = key;
    }
    ...
    private HttpEntity createMultipartEntity(ResponseHandlerInterface progressHandler) throws IOException {
        ...
        for (ConcurrentHashMap.Entry<String, FileWrapper> entry : fileParams.entrySet()) {
            ...
            if("".equals(filesKey)){
                ...
                entity.addPart(filesKey, fileWrapper.file, fileWrapper.contentType, fileWrapper.customFileName);
            }
        }
